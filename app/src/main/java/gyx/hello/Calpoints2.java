...
public class Calpoints2 {
    ...
    public List<String> remoData(List<DataBean> listTemp) {
        ...
        for (int i = 0; i < listTemp.size(); i++) {
            ...
            if (listTemp.get(i).getSubName().equals(pe1) ||
                listTemp.get(i).getSubName().equals(pe2) ||
                listTemp.get(i).getSubName().equals(pe3) ||
                listTemp.get(i).getSubName().equals(pe4) ||
                listTemp.get(i).getSubName().equals(pePro) ||
                listTemp.get(i).getAttr().equals(random)
    ...
    public double calculatePoint(List<DataBean> listTemp, List<String> listRemove, double bsum) {
        ...
        for (int i = 0; i < listTemp.size(); i++) {
            ...
            String td = listTemp.get(i).getPoints();
            if (td == "") {
                continue;
            }
            double td2 = Double.parseDouble(td);
            atemp = (tr2 - 50) / 10 * td2;
            asum += atemp;
            //bsum += td;
